...
engine = pyttsx3.init()
text = "Welcome to the Tic Tac Toe Game  , win to learn a new twi word."
engine.say(text)
engine.runAndWait()
...
def checkifwon():
    ...
    if b1["text"] == "X" and b2["text"] == "X" and b3["text"] == "X":
        ...
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Tac Toe", "Ayeákoo!  X Wins!!")
        disable_all_buttons()
        ...
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Tac Toe", "Ayeákoo!  O Wins!!")
        disable_all_buttons()
